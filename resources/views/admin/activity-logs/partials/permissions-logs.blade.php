<div id="permissions-logs" class="tab-content">
    <div class="mb-4">
        <h3 class="text-lg font-semibold text-gray-900 mb-2">
            <i data-lucide="shield-check" class="w-5 h-5 inline mr-2 text-amber-600"></i>
                ...
                <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-amber-500">
                        ...
                        <div class="flex-1">
                            ...
                            @if($log->permission_reason)
                                <p class="text-xs text-gray-600 mb-2">
                                    ...
                                    <strong>Reason:</strong> {{ $log->permission_reason }}
                                </p>
                            @endif
                    ...
                    <div id="permissions-{{ $log->id }}" class="hidden mt-4 pt-4 border-t border-gray-200">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <h5 class="text-sm font-medium text-gray-700 mb-2">Status Change:</h5>
                                <div class="text-xs bg-gray-50 p-2 rounded border">
                                    <span class="text-red-600">{{ $log->old_status }}</span>
                                    <i data-lucide="arrow-right" class="w-3 h-3 inline mx-2"></i>
                            ...
                            @if($log->additional_data)
                                <div>
                                    ...
                                    <pre class="text-xs bg-blue-50 p-2 rounded border overflow-x-auto">{{ json_encode($log->additional_data, JSON_PRETTY_PRINT) }}</pre>
                                </div>
                            @endif
                        </div>
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">No Permissions Logs Found</h3>
