                ...
                <div class="p-6">
                    <form action="{{ route('admin.locations.update', $location) }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="text" name="name" id="name"
                                       ...
                                       value="{{ old('name', $location->name) }}" required placeholder="Masukkan nama lokasi (contoh: Kantor Pusat)">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-col gap-2">
                                    <label class="flex items-center gap-3 px-4 py-3 border border-gray-300 rounded-lg cursor-pointer transition-all duration-200 hover:border-sky-400 hover:bg-sky-50 has-[:checked]:border-sky-500 has-[:checked]:bg-sky-50">
                                        <input type="radio" name="type" value="wfo" class="w-4 h-4 text-sky-600 focus:ring-sky-500" {{ old('type', $location->type) === 'wfo' ? 'checked' : '' }}>
                                        <div class="flex items-center gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <label class="flex items-center gap-3 px-4 py-3 border border-gray-300 rounded-lg cursor-pointer transition-all duration-200 hover:border-sky-400 hover:bg-sky-50 has-[:checked]:border-sky-500 has-[:checked]:bg-sky-50">
                                        <input type="radio" name="type" value="wfa" class="w-4 h-4 text-sky-600 focus:ring-sky-500" {{ old('type', $location->type) === 'wfa' ? 'checked' : '' }}>
                                        <div class="flex items-center gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            {{-- Status Lokasi --}}
                            <div class="space-y-2" x-data="{ isActive: {{ old('is_active', $location->is_active) ? 'true' : 'false' }} }">
                                <label class="block text-sm font-semibold text-gray-700">
                                    <div class="flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="radius" id="radius"
                                   ...
                                   value="{{ old('radius', $location->radius) }}" required placeholder="500">
